...
import { MapPin, Users, TrendingUp, Zap, Target, Search, Smartphone, Layers, Code, CheckCircle, Brain, Rocket } from 'lucide-react';
                        ...
                        <div className="md:w-1/2">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start gap-4">
                                    <div className="bg-blue-600/20 p-2 rounded-lg text-blue-400"><MapPin size={24} /></div>
                                    <div>
                                ...
                                <div className="flex items-start gap-4">
                                    <div className="bg-purple-600/20 p-2 rounded-lg text-purple-400"><Brain size={24} /></div>
                                    <div>
                                ...
                                <div className="flex items-start gap-4">
                                    <div className="bg-green-600/20 p-2 rounded-lg text-green-400"><Smartphone size={24} /></div>
                                    <div>
                    ...
                    <div className="flex justify-center">
                        <div className="bg-white p-8 rounded-2xl shadow-xl border border-slate-100 max-w-md w-full relative overflow-hidden group">
                            ...
                            <div className="w-24 h-24 bg-slate-200 rounded-full mx-auto mb-4 overflow-hidden border-4 border-white shadow-md">
                                <img src="/api/placeholder/150/150" alt="Umidjon" className="w-full h-full object-cover" /> 
                            </div>
                            ...
                            <div className="mt-6 flex justify-center gap-4">
                                <button className="text-slate-400 hover:text-blue-600 transition"><Users size={20} /></button>
                                <button className="text-slate-400 hover:text-slate-900 transition"><Code size={20} /></button>
                            </div>
                        </div>
                    </div>
